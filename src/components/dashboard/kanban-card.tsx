        ...
        >
          ...
          <div className="space-y-2 pt-2 border-t border-gray-100">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className="text-[10px] font-medium bg-gray-100 text-gray-650 dark:bg-slate-800 dark:text-slate-300 px-2 py-0.5 rounded-full truncate max-w-[80px]"
                title={translateCategory(request.category)}
              >

...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  const variants: Record<string, string> = {
    ...
    outline:
      "bg-transparent border border-gray-300 text-gray-800 dark:border-slate-700 dark:text-slate-300",

    // Status
    pending:
      "bg-amber-100 text-amber-800 border-amber-200 shadow-sm dark:bg-amber-900/30 dark:text-amber-200 dark:border-amber-900/50",
    in_review:
      "bg-fuchsia-100 text-fuchsia-800 border-fuchsia-200 shadow-sm dark:bg-fuchsia-900/30 dark:text-fuchsia-200 dark:border-fuchsia-900/50",
    approved:
      "bg-emerald-100 text-emerald-800 border-emerald-200 shadow-sm dark:bg-emerald-900/30 dark:text-emerald-200 dark:border-emerald-900/50",
    rejected:
      "bg-rose-100 text-rose-800 border-rose-200 shadow-sm dark:bg-rose-900/30 dark:text-rose-200 dark:border-rose-900/50",
    closed:
      "bg-slate-200 text-slate-700 border-slate-300 shadow-sm dark:bg-slate-800/60 dark:text-slate-300 dark:border-slate-700/50",

    // Priority
    low: "bg-teal-50 text-teal-700 border-teal-200 dark:bg-teal-900/30 dark:text-teal-200 dark:border-teal-900/50",
    medium:
      "bg-orange-50 text-orange-700 border-orange-200 dark:bg-orange-900/30 dark:text-orange-200 dark:border-orange-900/50",
